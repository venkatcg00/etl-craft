...
> **Status: pre-release rewrite.** This branch (`next`) rebuilds etl-craft in a layered,
> documented structure, ahead of the first release (0.1.0). Only `etl-craft --version` works so
