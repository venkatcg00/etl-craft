...
etl-craft is pre-release software. Security fixes are assessed against the current
...
- Back up the Engine DB before upgrading, and run `etl-craft migrate` after installing a new
  version.
