...
| G1b | `feat/services-generate-yml` | `generate-yml` | `generate_yml.py` | E2 | |
| G1c | `feat/services-lineage-docs` | `lineage`, `docs-version`, `generate-docs` | `docs_generator.py`, `column_lineage.py`, `documentation.py` | E2, F1 | |
